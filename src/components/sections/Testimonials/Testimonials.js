    ...
    <TestimonialsContainer id="testimonials">
      <div className="container">
        <SectionHeading 
          ...
          title="CLIENT"
          accent="FEEDBACK"
          subtitle="Direct insights from professional collaborations. These testimonials reflect my dedication to technical excellence, clear communication, and delivering impactful business results."
        />
